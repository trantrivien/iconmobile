  ...
  return (
    <div className="space-y-2 mt-2">
      ...
      <div className="flex items-center gap-6">
        <div className="">
          {/* Original Price */}
          <p className="text-muted-foreground line-through text-2xl hidden">
            ${product?.price}
          </p>
          <p className="text-lg font-bold text-red-600">Giá: Liên Hệ</p>
      ...
      <div className="flex flex-col md:flex-row items-center gap-4 !my-6 hidden">
        {/* Add To Cart Button */}
